    ...
    <TableStylesMain>
      ...
      <ContainerBodyTable>
        ...
        <tr>
          ...
          <td>
            <Typography variant="caption" component="span">
              Acceso a fuentes gratuitas de texto
            </Typography>
          </td>
          <td>
            <Typography variant="caption" component="span">
              Acceso a fuentes basicas de texto
            </Typography>
          </td>
          <td>
            <Typography variant="caption" component="span">
              Acceso a fuentes premium de texto
            </Typography>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <Typography variant="caption" component="span">
              Sube imagenes solo en JPG
            </Typography>
          </td>
          <td>
            <Typography variant="caption" component="span">
              Sube imagenes en JPG y PNG
            </Typography>
          </td>
          <td>
            <Typography variant="caption" component="span">
              Sube imagenes en JPG, PNG y JPEG
            </Typography>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <Typography variant="caption" component="span">
              Consulta con Arturito hasta 10 veces
            </Typography>
          </td>
          <td>
            <Typography variant="caption" component="span">
              Consulta con Arturito hasta 30 veces
            </Typography>
          </td>
          <td>
            <Typography variant="caption" component="span">
              Consultas ilimitadas a Arturito
            </Typography>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <Typography variant="caption" component="span">
              Descargas en A4 con marca de agua
            </Typography>
          </td>
          <td>
            <Typography variant="caption" component="span">
              Descargas en A4, A3 y Oficio
            </Typography>
          </td>
          <td>
            <Typography variant="caption" component="span">
