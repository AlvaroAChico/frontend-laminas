            ...
            <Table sx={{ minWidth: 650, boxShadow: "none" }} aria-label="simple table">
              ...
              <TableBody>
                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                  <TableCell><Typography variant="body2" component="p">Básico</Typography></TableCell>
                  <TableCell>
                    <Typography
                      variant="body2"
                      component="p"
                  ...
                  <TableCell><Typography variant="body2" component="p">2023-02-06</Typography></TableCell>
                  <TableCell><Typography variant="body2" component="p">14 / 20</Typography></TableCell>
                </TableRow>
                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                  <TableCell><Typography variant="body2" component="p">Premium</Typography></TableCell>
                  <TableCell>
                    <Typography
                      variant="body2"
                      component="p"
